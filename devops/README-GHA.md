...
2. Go to your repository at [edgard-leonel/tremt](https://github.com/edgard-leonel/tremt).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `tremt-edgard-leonel.tangrama.com.br` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | tremt-edgard-leonel.tangrama.com.br | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | tremt-edgard-leonel.tangrama.com.br |
...
- [Backend Tests Workflow](https://github.com/edgard-leonel/tremt/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/edgard-leonel/tremt/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/edgard-leonel/tremt-backend`) and Frontend (`ghcr.io/edgard-leonel/tremt-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of tremt-edgard-leonel.tangrama.com.br](https://github.com/edgard-leonel/tremt/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/tremt-edgard-leonel.tangrama.com.br.yml` stack.
